  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => OrderDetail2ndScreen()));
        },
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                Padding(
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 5),
                    child: Text('Wasiting for confrmation from store',style: kHeading16),
                  ),
                  SizedBox(height: 5),
                  Container(
