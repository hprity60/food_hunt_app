...
import 'order_detail_8th.dart';

class OrderDetail7thScreen extends StatefulWidget {
  OrderDetail7thScreen({Key? key}) : super(key: key);

  @override
  _OrderDetail7thScreenState createState() => _OrderDetail7thScreenState();
}

class _OrderDetail7thScreenState extends State<OrderDetail7thScreen> {
  int id = 1;
  int activeStep = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => OrderDetail8thScreen()));
        },
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        width: 56,
                        color: kPrimaryColor,
                        child: Text('Pick-Up', style: kHeading14.copyWith(color: kWhiteColor),),
                      )
                    ],
                  ),
                ),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 5),
                  child: Text('Your order is confrmed, you can pick in 35-40 mins ',style: kHeading16),
                ),
                SizedBox(height: 5),
                Container(
