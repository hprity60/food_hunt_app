...
class OrderDetail8thScreen extends StatefulWidget {
  OrderDetail8thScreen({Key? key}) : super(key: key);

  @override
  _OrderDetail8thScreenState createState() => _OrderDetail8thScreenState();
}

class _OrderDetail8thScreenState extends State<OrderDetail8thScreen> {
  int id = 1;
  int activeStep = 0;
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      SizedBox(height: 20),
                      Text('Order Pickd', style: kHeading40,),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 5),
                  child: Text('Picked Succesfully',style: kHeading16),
                ),
                SizedBox(height: 5),
                Container(
