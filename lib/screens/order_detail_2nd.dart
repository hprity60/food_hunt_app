...
import 'package:hello/screens/order_detail_3rd.dart';
import 'package:timelines/timelines.dart';
import 'package:hello/common/widgets/custom_container.dart';

class OrderDetail2ndScreen extends StatefulWidget {
  OrderDetail2ndScreen({Key? key}) : super(key: key);

  @override
  _OrderDetail2ndScreenState createState() => _OrderDetail2ndScreenState();
}

class _OrderDetail2ndScreenState extends State<OrderDetail2ndScreen> {
  int id = 1;
  int activeStep = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => OrderDetail3rdScreen()));
        },
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 5),
                  child: Text('Your Order is Confirmed',style: kHeading16),
                ),
                SizedBox(height: 5),
                Container(
